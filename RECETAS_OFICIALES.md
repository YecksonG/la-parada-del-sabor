# 📖 Recetario Oficial & Escandallos de Producción — La Parada del Sabor
...
### 1.1 Arepa Jamón y Queso Amarillo
- **Precio de Venta:** `$2.00 USD`
- **Descripción:** Arepa asada o frita rellena con jamón de pavo y abundante queso amarillo rallado con un toque de mantequilla derretida.
- **Escandallo de Ingredientes:**
  ...
  | Jamón de Pavo | 20.00 | g |
  | Queso Amarillo Rallado | 50.00 | g |
  | **Peso Total Relleno:** | **70.00** | **g** |

---

### 1.2 Arepa Reina Pepiada
- **Precio de Venta:** `$2.00 USD`
- **Descripción:** Arepa asada o frita rellena con pechuga de pollo mechada en una emulsión suave de aguacate maduro, mayonesa y especias criollas.
- **Escandallo de Ingredientes:**
  | Ingrediente / Insumo | Cantidad / Peso | Unidad |
  | :--- | :--- | :--- |
  | Harina PAN (Masa base) | 27.59 | g |
  | Mantequilla / Margarina | 7.50 | g |
  | Pechuga de Pollo Mechada | 50.00 | g |
  | Aguacate Maduro | 30.00 | g |
  | **Peso Total Relleno:** | **80.00** | **g** |

---

### 1.3 Arepa Catira
- **Precio de Venta:** `$2.20 USD`
- **Descripción:** Arepa asada o frita rellena con jugoso pollo mechado sazonado y coronada con queso amarillo rallado tipo gouda.
- **Escandallo de Ingredientes:**
  | Ingrediente / Insumo | Cantidad / Peso | Unidad |
  | :--- | :--- | :--- |
  | Harina PAN (Masa base) | 27.59 | g |
...
### 1.5 Arepa Especial de Carne Esmechada
- **Precio de Venta:** `$3.50 USD`
- **Descripción:** Nuestra arepa insigne: rellena de carne de res esmechada, jamón de pavo, queso blanco llanero rallado, vegetales frescos y dúo de salsas especiales (tártara y rosada/maíz).
- **Escandallo de Ingredientes:**
  | Ingrediente / Insumo | Cantidad / Peso | Unidad |
  | :--- | :--- | :--- |
  | Harina PAN (Masa base) | 27.59 | g |
  ...
  | Jamón de Pavo | 10.00 | g |
  | Queso Blanco Llanero | 50.00 | g |
  | Salsas Especiales (Tártara + Rosada/Maíz) | 18.00 | ml |
  | **Peso Total Relleno:** | **128.00** | **g / ml** |

---

### 1.6 Arepa Especial de Pollo Esmechado
- **Precio de Venta:** `$2.80 USD`
- **Descripción:** Arepa gourmet rellena de pechuga de pollo esmechada, jamón de pavo, queso blanco llanero rallado, vegetales y salsas especiales.
- **Escandallo de Ingredientes:**
  | Ingrediente / Insumo | Cantidad / Peso | Unidad |
  | :--- | :--- | :--- |
  | Harina PAN (Masa base) | 27.59 | g |
...
- **Escandallo Base:**
  | Ingrediente / Insumo | Cantidad / Peso | Unidad |
  | :--- | :--- | :--- |
  | Harina PAN (4 Arepitas) | 110.34 | g |
  | Mantequilla (4 Arepitas) | 30.00 | g |
  | Rellenos a Elección | Descontado según selección | g |
  | Caja Descartable Mediana | 1.00 | und |
  | Refresco 1 Litro | 1.00 | und |
...
- **Escandallo Base:**
  | Ingrediente / Insumo | Cantidad / Peso | Unidad |
  | :--- | :--- | :--- |
  | Harina PAN (10 Arepitas) | 275.86 | g |
  | Mantequilla (10 Arepitas) | 75.00 | g |
  | Rellenos a Elección | Descontado según selección | g |
  | Caja Descartable Familiar | 1.00 | und |
  | Refresco Pepsi 1.5L | 1.00 | und |
...
## 🧀 4. Extras y Modificadores

Los clientes pueden agregar porciones adicionales a cualquier arepa desde el POS o la Web:

| Modificador / Extra | Porción / Gramaje | Precio Adicional ($ USD) |
| :--- | :--- | :--- |
| **Extra Queso Amarillo** | 50.00 g | `+$0.50 USD` |
| **Extra Queso Blanco Llanero** | 50.00 g | `+$0.50 USD` |
| **Extra Jamón de Pavo** | 20.00 g | `+$0.50 USD` |
| **Extra Aguacate** | 30.00 g | `+$0.50 USD` |
| **Extra Pollo Mechado** | 50.00 g | `+$1.00 USD` |
| **Extra Carne Mechada** | 50.00 g | `+$1.00 USD` |

---

*Documento técnico sincronizado con la base de datos PostgreSQL de Supabase y el módulo de Escandallos de La Parada del Sabor.*
