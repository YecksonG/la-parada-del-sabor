-- ==============================================================================
-- MIGRACIÓN: SEGURIDAD ANTI-SPAM & RATE LIMITING DE PEDIDOS WEB (NIVEL DB)
-- ==============================================================================
...
-- 2. Función RPC blindada con límites de seguridad y prevención de ataques
...
BEGIN
    ...
    IF v_cliente_id IS NOT NULL THEN
        ...
        IF v_pedidos_pendientes >= 2 THEN
            RETURN jsonb_build_object('ok', false, 'error', 'Ya tienes 2 pedidos en espera de confirmación. Por favor espera a que cocina los procese.');
        END IF;
