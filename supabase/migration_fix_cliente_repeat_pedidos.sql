-- ==============================================================================
-- MIGRACIÓN DE CORRECCIÓN: RE-PEDIDOS DE CLIENTES EXISTENTES & REFRESH EN PEDIDOS WEB
-- ==============================================================================

-- 1. Asegurar columna actualizado_el en clientes
ALTER TABLE public.clientes ADD COLUMN IF NOT EXISTS actualizado_el TIMESTAMPTZ DEFAULT NOW();

-- 2. Actualizar función RPC fn_crear_pedido_web con resolución de cliente existente y ordenamiento por fecha
