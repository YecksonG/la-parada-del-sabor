...
BEGIN
    ...
    -- Eliminamos cualquier política abierta de lectura/escritura masiva de ventas o clientes para anon
...
-- 6. FUNCIÓN ATÓMICA RPC PARA CREAR PEDIDOS WEB DE FORMA SEGURA (SECURITY DEFINER)
...
BEGIN
    ...
    LOOP
        ...
        -- Validación estricta de cantidad (G2 fix)
